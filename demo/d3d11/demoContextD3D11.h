...
class DebugLineRenderD3D11;
class MeshRendererD3D11;
class PointRendererD3D11;
class DiffuseRendererD3D11;
class AppGraphCtx;
class AppGraphCtxD3D11;
class GpuMeshD3D11;
...
protected:
	...
	friend void ExportPartices(FluidRenderBuffers* vBuffer);
};
